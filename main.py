...
import random
import send_email
print '                                     Welcome to Hianshi Net Banking'
class bank:
    def rtc(self):
    ...
    def email(self):
        while True:
            e_mail=raw_input('Enter your E-mail: ')
            co=['.','@']
            e_list=list(e_mail)
            if co[0] in e_mail:
                if co[1] in e_mail:
    ...
    def reset_password(self):
        while True:         #To check confirm password
            ...
            while (a1!=1 or b1!=1 or c1!=1 or d1!=1):
                ...
                print 'Password must contain Small/Big Character,Numberic and Special character.'
                pa_password=raw_input('Enter password: ')
                co1=['!','@','#','$','%','^','&','*']
            ...
            self.c_password=raw_input('Enter password again to confirm: ')
    ...
    def signup(self):
        ...
        print 'Enter details:'
        self.f_name=raw_input('Enter your first name: ')
        if self.f_name=='e':
            return
        
        self.l_name=raw_input('enter your last name: ')
        self.u_name=raw_input('Enter User name: ')
    ...
    def login(self):
        ...
        while ct<4:
            if self.flag[0]==1:
                ...
                ct+=1
                c_user=raw_input('Enter User_ID: ')
                c_password=raw_input('Enter Password: ')
    ...
    def account(self):
        ...
        if self.a1_select==1:
            ...
            p_pass=raw_input('Enter previous password: ')
            ...
            if t_type==1:                
                ...
                print 'Account balance= ',self.a_balance
                d_amount=input('Enter amount to be credit: ')
                self.a_balance=int(self.a_balance)
                self.a_balance+=d_amount
                print 'balance= ',self.a_balance
                A_detail=open('Account_Details.csv','a')
...
while True:     #To open Bank account
    L_select=input('Select option to open account\n 1.Login\t2.Signup\n Enter number: ')
    if L_select==2:
        bank.signup()
    elif L_select==1:
        a=bank.login()
